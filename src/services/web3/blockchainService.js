/**
 * Blockchain abstraction layer (mock-first, contract-ready).
 *
 * This service provides a stable API for all blockchain interactions used by
 * the frontend. The current implementation is in-memory/localStorage backed and
 * simulates chain latency + transaction lifecycle. Later migration only needs
 * implementation changes in this file.
 */
...
class BlockchainService {
   ...
   * Future implementation can switch to 'evm', 'solana', or per-network adapters.
   */
  implementation = 'mock';
