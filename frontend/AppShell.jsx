      ...
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        {!isAuthenticated ? (
          <section className="mx-auto max-w-xl rounded-3xl border border-cyan-400/30 bg-slate-900/85 p-6 text-center shadow-2xl shadow-cyan-900/20 backdrop-blur">
            ...
            <h2 className="mt-2 text-3xl font-bold text-cyan-300">Enter SN1 Launchpad</h2>
            <p className="mt-2 text-sm text-slate-300">Set a pilot name (optional), then continue to wallet connect and token launch.</p>
            <form className="mt-5 space-y-3" onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                className="pointer-events-auto w-full cursor-pointer rounded-xl bg-gradient-to-r from-cyan-400 to-emerald-400 px-4 py-3 font-bold text-slate-950 transition hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-cyan-300"
              >
